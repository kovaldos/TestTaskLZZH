...
/* harmony import */ var _modules_init_posted_works_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-posted-works-slider */ "./js/modules/init-posted-works-slider.js");
/* harmony import */ var _modules_init_burger_menu__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-burger-menu */ "./js/modules/init-burger-menu.js");
/* harmony import */ var _modules_scroll_to_top__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/scroll-to-top */ "./js/modules/scroll-to-top.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_posted_works_slider__WEBPACK_IMPORTED_MODULE_4__["initPostedWorksSlider"])();
    Object(_modules_init_burger_menu__WEBPACK_IMPORTED_MODULE_5__["initBurgerMenu"])();
    Object(_modules_scroll_to_top__WEBPACK_IMPORTED_MODULE_6__["initBtnToTop"])();
  });
}); // ---------------------------------
...
var initBurgerMenu = function initBurgerMenu() {
  var iconMenu = document.querySelector('[data-menu-icon]');
...
/***/ "./js/modules/init-posted-works-slider.js":
/*!************************************************!*\
  !*** ./js/modules/init-posted-works-slider.js ***!
  \************************************************/
/*! exports provided: initPostedWorksSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initPostedWorksSlider", function() { return initPostedWorksSlider; });
// slider in posted works section -- Start --

/* eslint-disable no-undef */
var initPostedWorksSlider = function initPostedWorksSlider() {
  var PostedWorksSlider = document.querySelector('.posted-works__slider');

  if (PostedWorksSlider) {
    // eslint-disable-next-line no-unused-vars
    var swiper01 = new Swiper(PostedWorksSlider, {
      // Navigation arrows
      navigation: {
...
/*!*************************************!*\
  !*** ./js/modules/scroll-to-top.js ***!
  \*************************************/
/*! exports provided: initBtnToTop */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initBtnToTop", function() { return initBtnToTop; });
...
var initBtnToTop = function initBtnToTop() {
  var btnToTop = document.querySelector('[data-scroll-button]');
  ...
  if (btnToTop) {
    ...
    window.addEventListener('scroll', function () {
      ...
      if (this.scrollY > scrollHeight) {
        btnToTop.classList.add('is-active'); // Иначе прячем
      } else {
    ...
    btnToTop.addEventListener('click', function (e) {
      e.preventDefault(); // Вызываем функцию, первый аргумент - отступ, второй - скорость скролла, чем больше значение, тем медленнее скорость прокрутки

      Object(_utils_scroll_to__WEBPACK_IMPORTED_MODULE_0__["scrollTo"])(0, 400);
    });
  }
};
